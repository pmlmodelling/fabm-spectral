...
write('../../src/slingo_const.inc', nlambda_slingo=len(lambda_min), lambda_min_slingo=lambda_min*1000, lambda_max_slingo=lambda_max*1000, lambda_slingo=(lambda_min + lambda_max)*500, a_slingo=a, b_slingo=b, c_slingo=c, d_slingo=d, e_slingo=e, f_slingo=f)
